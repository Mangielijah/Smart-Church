...
<?php include 'layout.php' ?>
                ...
                <form method="post" action='#' class='form-horizontal' role='form' enctype="multipart/form-data">
                    ...
                    <div class='form-group'>
                      <div class='col-md-10'>
                        <input type='hidden' class='form-control' id='groupid' name='groupid' value='1' disabled required>
                      </div>
                    </div>
                    <div class='form-group'>
                      <div class='col-md-10'>
                        <input type='text' class='form-control' id='leadername' name='leadername' placeholder="enter group leader..." required>
                      </div>
                    </div>
